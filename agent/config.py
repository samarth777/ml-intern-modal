...
class Config(BaseModel):
    ...
    # Compute backend selection: "modal" (Modal Sandboxes + Modal Functions,
    # default) or "hf" (Hugging Face Spaces + HF Jobs, legacy). When set to
    # "modal", the agent's sandbox and jobs tools are backed by modal.com
    # infrastructure (see modal_app.py and agent/tools/modal_*.py).
    compute_backend: str = "modal"
